...
* **Task 1.1: Initialize Monorepo**
    * Create `tv-streaming-app` root directory.
    * Create `backend/`, `frontend/` directories.
    * Add initial `README.md` and `.gitignore`.
* **Task 1.2: Docker Compose for Infrastructure**
...
* **Task 1.3: Base FastAPI Service Setup**
...
* **Task 1.4: Initial API Gateway Skeleton**
...
* **Task 1.5: Verify Basic Infrastructure**
...
* **Task 2.1: User Management Service Development**
...
* **Task 2.2: Authentication Service Development**
    ...
    * Add initial unit tests.
* **Task 2.3: API Gateway Integration for Auth & Users**
    * Update API Gateway:
...
* **Task 2.4: Integration Testing (Auth & Users)**
...
* **Task 3.1: On-Demand Video Service Development**
    ...
    * Add initial unit tests.
* **Task 3.2: Live TV Service Development**
    ...
    * Add initial unit tests.
* **Task 3.3: API Gateway Integration for Content**
    * Update API Gateway with routes for `/ondemand/*` and `/livetv/*` (authenticated access).
* **Task 3.4: Integration Testing (Content Browsing)**
...
* **Task 4.1: Rights Management Service Development**
    ...
    * Add initial unit tests.
* **Task 4.2: Playback Endpoint Integration**
...
* **Task 4.3: API Gateway Integration for Playback & Rights**
...
* **Task 4.4: Integration Testing (Rights & Playback)**
...
* **Task 5.1: Global Search Service Development**
...
* **Task 5.2: Asynchronous Indexing Setup**
...
* **Task 5.3: API Gateway Integration for Global Search**
    * Update API Gateway with the route for `GET /search/global`.
* **Task 5.4: Integration Testing (Global Search)**
...
* **Task 6.1: Admin API Endpoints Implementation**
...
* **Task 6.5: Security Hardening (Demonstrator Level)**
...
* **Task 7.2: Core Frontend Integration**
